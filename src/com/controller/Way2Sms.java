...
public class Way2Sms {
   // private URLConnection sendSMSConnection;
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
         ...
         //   urlLogin=new URL("http://site5.way2sms.com/Login1.action");
            ...
            loginConnection.setRequestProperty("Referer", "http://site25.way2sms.com//entry.jsp");
    ...
    {  
        final String USERNAME="8490021614";//REQUIRED
        final String PASSWORD="rmn8141629062";//REQUIRED
     ...
     /*   if(args.length>0)
        ...
        { */
            String msg2=" hii akash ramani"; //msg to be sent
            phoneNumber.append("8141629062"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
            phoneNumber.append(';');
